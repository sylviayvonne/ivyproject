...
try 
{
    ...
    $mail->Host = 'mail.globalforensics.co.ke';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'ivydesigns20@globalforensics.co.ke';                 // SMTP username
    $mail->Password = 'ivysylvia20';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('ivydesigns20@globalforensics.co.ke', 'Ivy Designs');
